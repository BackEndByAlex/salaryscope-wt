...
**`dashboard/`** — The core of the app. A 3D globe where you click countries and cities to see salary breakdowns. A left sidebar with filter controls. A right sidebar with a paginated salary list and a range slider. See [dashboard/README.md](./dashboard/README.md).

**`analytics/`** — A static analytics view with five sections: dataset overview, top countries, top rated companies, job categories, and experience/work-setting breakdowns. No interactivity — just queries and charts. See [analytics/README.md](./analytics/README.md).

**`landing/`** — The public home page with hero, stats, features, and CTA sections. Minimal logic. See [landing/README.md](./landing/README.md).

**`profile/`** — The authenticated user's page. Shows their identity, linked OAuth providers, and any salary records they have submitted. See [profile/README.md](./profile/README.md).
